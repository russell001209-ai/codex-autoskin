...
Write-Host 'Codex Dream Skin installed. Your existing Codex appearance setting was preserved.'
if ($ApplyLegacyBaseTheme) { Write-Host 'Legacy light base-theme override was explicitly enabled.' }
